...
void moveMotor(int angle, int speedPercent) {
  ...
  while (_step_current_position != step_target_position) {
    ...
    //Serial.print("ST,0,RETMOVE,ERR_LESS,_step_current_position " + String(_step_current_position) + "," ",ED\r\n");
    ...
    if (isClockwise == false && _step_current_position <= _step_start_position) {
      ...
      //Serial.print("ST,0,RETMOVE,ERR_LESS,isClockwise " + String(isClockwise) + "," + String(speedPercent) + ",ED\r\n");
      return;
    }
  }
